...
// API base: prefer env override for deployed frontend; fall back to the dedicated backend domain + /api.
...
const DEFAULT_API_BASE = 'https://se3200-expense-tracker-2025-group-2-backend-production.up.railway.app/api';
const API_BASE_PATH =
  apiBaseFromEnv.trim() ||
